...
- **API**: FastAPI application under `backend/` exposing 39 REST endpoints across health, analytics, customer intelligence, predictions, retention, products, sellers, and marketing.
- **Testing**: 192 automated tests in `tests/` (154 offline mock/unit tests, 38 live DB integration tests skipped without `DATABASE_URL`).
