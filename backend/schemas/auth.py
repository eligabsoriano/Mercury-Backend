...
class TokenRequest(BaseModel):
    ...
    client_id: str = Field(default="mercury_client", description="Client or application identifier.")
...
class UserIdentity(BaseModel):
    ...
    auth_type: str = Field(..., description="Authentication mechanism ('api_key', 'bearer', 'dev_bypass').")
