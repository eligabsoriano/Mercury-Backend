...
class SellerSummary(BaseModel):
    ...
    total_orders_fulfilled: int = Field(0, description="Count of distinct delivered orders fulfilled")
    ...
    total_revenue: float = Field(0.0, description="Gross revenue generated (items + freight) in BRL")
    ...
    late_delivery_rate: float = Field(0.0, description="Percentage of orders delivered past estimated date")
    avg_review_score: Optional[float] = Field(None, description="Mean customer review rating (1.0 - 5.0)")
